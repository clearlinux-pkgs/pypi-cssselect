...
Source0  : https://files.pythonhosted.org/packages/72/0a/c3ea9573b1dc2e151abfe88c7fe0c26d1892fe6ed02d0cdb30f0d57029d5/cssselect-1.3.0.tar.gz
...
%prep
%setup -q -n cssselect-1.3.0
cd %{_builddir}/cssselect-1.3.0
pushd ..
cp -a cssselect-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742454749
